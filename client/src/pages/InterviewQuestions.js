...
export default function InterviewQuestions() {
  ...
  const handleComplete = async () => {
    const payload = {
      questions: questions.map((q) => q.question), // Only send the questions in the required format
      ...
      <div className="container container-int">
        ...
        <div className="d-flex-int mt-4">
          <div className="left-panel-int flex-fill">
            ...
            <div className="d-flex-int justify-content-between mt-4">
              <button
            ...
            <div className="text-center-int mt-4">
              <button
                className={`btn ${isRecording ? 'btn-danger blink-int' : 'btn-warning'}`}
            ...
            {currentQuestionIndex === questions.length - 1 && (
              <div className="text-center-int mt-4 mb-4">
                <button className="btn btn-success" onClick={handleComplete} disabled={!isWebcamActive}>
                  Submit Interview
                </button>
              </div>
            )}
